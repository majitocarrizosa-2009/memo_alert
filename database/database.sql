-- ==========================================================
-- MEMO ALERT - BASE DE DATOS MYSQL COMPLETA
-- Sistema de Gestión de Pedidos, Memoria y Perfil del Emprendedor
-- Carpeta: database/database.sql
-- ==========================================================
...
-- --------------------------------------------------------
-- 6. Inserción de Pedidos de Prueba
-- --------------------------------------------------------
